...
export const CLIENT_NAMES = {
  국어: ["문장흐름이답답한학생", "비문학막힘형", "문학해석불안형"],
  수학: ["수학공포학생", "유형분류필요형", "개념부터잡고싶은학생"],
  영어: ["해석막힘형", "단어벼락치기형", "구문이복잡한학생"],
  사회탐구: ["개념비교필요형", "흐름연결학생", "암기정리원함형"],
  과학탐구: ["적용막힘형", "실수많은학생", "개념정리우선형"],
  기타: ["자유형의뢰자", "혼합형작업학생", "프로젝트정리형"]
};
